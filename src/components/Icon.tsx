...
const iconDefinitions = {
  gitHub: ({ strokeWidth }: PropsOutline) => (
    <svg viewBox="0 0 98 96" xmlns="http://www.w3.org/2000/svg" className="size-full">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  chevronRight: ({ strokeWidth }: PropsOutline) => (
    <svg
  ...
  logout: ({ strokeWidth }: PropsOutline) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
  ...
  check: ({ strokeWidth }: PropsOutline) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
